...
namespace Diff.Net
{
	partial class DirDiffForm
	{
		...
		private Menees.Diffs.Windows.Forms.DirectoryDiffControl DiffCtrl;
		...
		private void InitializeComponent()
		{
			...
			this.DiffCtrl = new Menees.Diffs.Windows.Forms.DirectoryDiffControl();
			...
			this.DiffCtrl.ShowFileDifferences += new System.EventHandler<Menees.Diffs.Windows.Forms.DifferenceEventArgs>(this.DiffCtrl_ShowFileDifferences);
			// 
			// MainMenu
			// 
